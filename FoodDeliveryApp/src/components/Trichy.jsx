...
const Trichy = () => {
  ...
  return (
    <>
    <Header/>
    <p id='loc'>Best Food in Trichy</p>
    ...
    <div className='showcase1'>
        <div className="box1">
              <img src='https://b.zmtcdn.com/data/pictures/4/19138984/7d53580d26dabfda72cea7898ebc83f9_featured_v2.jpg'></img>
              <div id='desc'>
              <b>KMS Hakkim Kalyana..</b>
              <b id='rating'>3.1 ★</b>
              </div>
              <p id='add'>KK Nagar, Trichy</p>
